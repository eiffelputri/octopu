            ...
            <div class="box">
                <form action="" method="POST" enctype="multipart/form-data">
                    <select class="input-control" name="materi" required>
                        ...
                        ?>
                        <option value="<?php echo $r['selflearning_id']?>"><?php echo $r['selflearning_mapel']?></option>
                        <?php } ?>
                    </select>

                    <input type="text" name="nama" class="input-control" placeholder="Nama Materi" required>
                ...
                <?php
                    if(isset($_POST['submit'])){
                        ...
                        if(!in_array($type2, $tipe_diizinkan)){
                            ...
                            $insert = mysqli_query($conn, "INSERT INTO tb_mapel VALUES (
                                        null,
                                        '".$materi."',
                                        '".$nama."',
                                        '".$harga."',
                            ...
                            if($insert){
                                echo '<script>alert("Tambah materi berhasil")</script>';
