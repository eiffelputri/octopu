<?php
    ...
    $produk = mysqli_query($connection, "SELECT * FROM tb_jenis_event WHERE jenis_id = '".$_GET['id']."' ");
...
<body>
    <div class="main">
        ...
        <div class="content">
            ...
            <div class="username1">
                <h1 style="text-align: center;">Detail Event</h1>
            </div>
                ...
                <div class="container">
                    <div class="box" style="background-color: #998fd5;">
                        <div class="col-2">
                            ...
                            <!-- CONNECT PHP | Gambar detail event nya -->
                            <img src="../event/<?php echo $p->jenis_gambar?>" width="100%">
                        ...
                        <div class="col-2">
                            <h2 class="judul_produk">
                                ...
                                <!-- CONNECT PHP | Nama event nya-->
                                <?php echo $p->jenis_nama ?>

                            </h2>
                            <h4 style="color: maroon;">

                                Rp <?php echo number_format($p->jenis_harga) ?>
                            </h4>
                            <p> Deskripsi : <br>
                                <!-- CONNECT PHP | Deskripsi event -->
                                <?php echo $p->jenis_desk?>
                            </p>
                            <p>
                            <h4>
